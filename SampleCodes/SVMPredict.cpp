...
int main(int argc, char ** argv)
{
	...
	{
		Mat drawing = imread(filenames[i], 0);
	...
	{
		Mat drawing2 = imread(filenames[i], 0);
		//Mat drawing = imread("img_new_pos1.jpg", 0);
		if (drawing2.empty())
		{
			std::cout << "not found!";
	...
	/********Prepare trainData and test data and call SVM ML algorithm*********/
